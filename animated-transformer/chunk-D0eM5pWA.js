import {ai as ce,aj as ie,ak as yd,al as Ct,l as f$1,am as P$1,an as Zt,ao as q,ap as kr,aq as Ig,ar as nr,h as _t,as as Ce,at as ft,au as vd,av as g4,m as me,aw as lm,ax as ee,ay as bt$1,az as Ve,b,C as Cn,E,M as wn,c as be,V as Dn,u as ut,aA as fa,aB as y,e as Ei,aC as Se,aD as da,aE as Yn,aF as Zn,aG as Ro,aH as G,g as Z,aI as A,aJ as ct$1,aK as le,aL as ue,O as In,aM as Ke,aN as Ut,aO as pC,a1 as Ft,aP as Ms,w,i as iu,a as xM,aQ as IM,d as TM,aR as Zp}from'./main-TU5BH5NZ.js';var vt=["knob"],gt=["valueIndicatorContainer"];function bt(s,c){if(s&1&&(b(0,"div",2,1)(2,"div",5)(3,"span",6),w(4),E()()()),s&2){let t=Ft();be(4),iu(t.valueIndicatorText);}}var Tt=["trackActive"],kt=["*"];function It(s,c){if(s&1&&Cn(0,"div"),s&2){let t=c.$implicit,i=c.$index,e=Ft(3);Ei(t===0?"mdc-slider__tick-mark--active":"mdc-slider__tick-mark--inactive"),Zp("transform",e._calcTickMarkTransform(i));}}function Rt(s,c){if(s&1&&xM(0,It,1,4,"div",8,IM),s&2){let t=Ft(2);TM(t._tickMarks);}}function xt(s,c){if(s&1&&(b(0,"div",6,1),wn(2,Rt,2,0),E()),s&2){let t=Ft();be(2),Dn(t._cachedWidth?2:-1);}}function yt(s,c){if(s&1&&Cn(0,"mat-slider-visual-thumb",7),s&2){let t=Ft();ut("discrete",t.discrete)("thumbPosition",1)("valueIndicatorText",t.startValueIndicatorText);}}var n=(function(s){return s[s.START=1]="START",s[s.END=2]="END",s})(n||{}),f=(function(s){return s[s.ACTIVE=0]="ACTIVE",s[s.INACTIVE=1]="INACTIVE",s})(f||{}),P=new y("_MatSlider"),ct=new y("_MatSliderThumb"),Mt=new y("_MatSliderRangeThumb"),mt=new y("_MatSliderVisualThumb");var St=(()=>{class s{_cdr=f$1(Zt);_ngZone=f$1(P$1);_slider=f$1(P);_renderer=f$1(ct$1);_listenerCleanups;discrete=false;thumbPosition;valueIndicatorText;_ripple;_knob;_valueIndicatorContainer;_sliderInput;_sliderInputEl;_hoverRippleRef;_focusRippleRef;_activeRippleRef;_isHovered=false;_isActive=false;_isValueIndicatorVisible=false;_hostElement=f$1(q).nativeElement;_platform=f$1(Ce);ngAfterViewInit(){let t=this._slider._getInput(this.thumbPosition);t&&(this._ripple.radius=24,this._sliderInput=t,this._sliderInputEl=this._sliderInput._hostElement,this._ngZone.runOutsideAngular(()=>{let i=this._sliderInputEl,e=this._renderer;this._listenerCleanups=[e.listen(i,"pointermove",this._onPointerMove),e.listen(i,"pointerdown",this._onDragStart),e.listen(i,"pointerup",this._onDragEnd),e.listen(i,"pointerleave",this._onMouseLeave),e.listen(i,"focus",this._onFocus),e.listen(i,"blur",this._onBlur)];}));}ngOnDestroy(){this._listenerCleanups?.forEach(t=>t());}_onPointerMove=t=>{if(this._sliderInput._isFocused)return;let i=this._hostElement.getBoundingClientRect(),e=this._slider._isCursorOnSliderThumb(t,i);this._isHovered=e,e?this._showHoverRipple():this._hideRipple(this._hoverRippleRef);};_onMouseLeave=()=>{this._isHovered=false,this._hideRipple(this._hoverRippleRef);};_onFocus=()=>{this._hideRipple(this._hoverRippleRef),this._showFocusRipple(),this._hostElement.classList.add("mdc-slider__thumb--focused");};_onBlur=()=>{this._isActive||this._hideRipple(this._focusRippleRef),this._isHovered&&this._showHoverRipple(),this._hostElement.classList.remove("mdc-slider__thumb--focused");};_onDragStart=t=>{t.button===0&&(this._isActive=true,this._showActiveRipple());};_onDragEnd=()=>{this._isActive=false,this._hideRipple(this._activeRippleRef),this._sliderInput._isFocused||this._hideRipple(this._focusRippleRef),this._platform.SAFARI&&this._showHoverRipple();};_showHoverRipple(){this._isShowingRipple(this._hoverRippleRef)||(this._hoverRippleRef=this._showRipple({enterDuration:0,exitDuration:0}),this._hoverRippleRef?.element.classList.add("mat-mdc-slider-hover-ripple"));}_showFocusRipple(){this._isShowingRipple(this._focusRippleRef)||(this._focusRippleRef=this._showRipple({enterDuration:0,exitDuration:0},true),this._focusRippleRef?.element.classList.add("mat-mdc-slider-focus-ripple"));}_showActiveRipple(){this._isShowingRipple(this._activeRippleRef)||(this._activeRippleRef=this._showRipple({enterDuration:225,exitDuration:400}),this._activeRippleRef?.element.classList.add("mat-mdc-slider-active-ripple"));}_isShowingRipple(t){return t?.state===Ut.FADING_IN||t?.state===Ut.VISIBLE}_showRipple(t,i){if(!this._slider.disabled&&(this._showValueIndicator(),this._slider._isRange&&this._slider._getThumb(this.thumbPosition===n.START?n.END:n.START)._showValueIndicator(),!(this._slider._globalRippleOptions?.disabled&&!i)))return this._ripple.launch({animation:this._slider._noopAnimations?{enterDuration:0,exitDuration:0}:t,centered:true,persistent:true})}_hideRipple(t){if(t?.fadeOut(),this._isShowingAnyRipple())return;this._slider._isRange||this._hideValueIndicator();let i=this._getSibling();i._isShowingAnyRipple()||(this._hideValueIndicator(),i._hideValueIndicator());}_showValueIndicator(){this._hostElement.classList.add("mdc-slider__thumb--with-indicator");}_hideValueIndicator(){this._hostElement.classList.remove("mdc-slider__thumb--with-indicator");}_getSibling(){return this._slider._getThumb(this.thumbPosition===n.START?n.END:n.START)}_getValueIndicatorContainer(){return this._valueIndicatorContainer?.nativeElement}_getKnob(){return this._knob.nativeElement}_isShowingAnyRipple(){return this._isShowingRipple(this._hoverRippleRef)||this._isShowingRipple(this._focusRippleRef)||this._isShowingRipple(this._activeRippleRef)}static \u0275fac=function(i){return new(i||s)};static \u0275cmp=me({type:s,selectors:[["mat-slider-visual-thumb"]],viewQuery:function(i,e){if(i&1&&da(pC,5)(vt,5)(gt,5),i&2){let a;Yn(a=Zn())&&(e._ripple=a.first),Yn(a=Zn())&&(e._knob=a.first),Yn(a=Zn())&&(e._valueIndicatorContainer=a.first);}},hostAttrs:[1,"mdc-slider__thumb","mat-mdc-slider-visual-thumb"],inputs:{discrete:"discrete",thumbPosition:"thumbPosition",valueIndicatorText:"valueIndicatorText"},features:[fa([{provide:mt,useExisting:s}])],decls:4,vars:2,consts:[["knob",""],["valueIndicatorContainer",""],[1,"mdc-slider__value-indicator-container"],[1,"mdc-slider__thumb-knob"],["matRipple","",1,"mat-focus-indicator",3,"matRippleDisabled"],[1,"mdc-slider__value-indicator"],[1,"mdc-slider__value-indicator-text"]],template:function(i,e){i&1&&(wn(0,bt,5,1,"div",2),Cn(1,"div",3,0)(3,"div",4)),i&2&&(Dn(e.discrete?0:-1),be(3),ut("matRippleDisabled",true));},dependencies:[pC],styles:[`.mat-mdc-slider-visual-thumb .mat-ripple {
  height: 100%;
  width: 100%;
}
